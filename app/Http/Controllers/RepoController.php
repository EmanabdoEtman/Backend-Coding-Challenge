...
class RepoController extends Controller
{
    ...
    {
        try {
            return $this->repository->getFilterByLanguageRepository($request->language,$request->length);
        } catch (GuzzleException $e) {
            return response()->json(['message'=>'Data is not found or has expired.'],422);
        }
    }
    ...
    {
        try {
            return $this->repository->getFilterByDateRepository($request->date,$request->length);
        } catch (GuzzleException $e) {
